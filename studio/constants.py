"""AI Content Studio — 常量、颜色、字体、模型映射"""

import os

# ============ 日志 ============
LOG_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "crash.log")
...
# 间距
PAD_XS = 4; PAD_SM = 8; PAD_MD = 12; PAD_LG = 16; PAD_XL = 24; PAD_XXL = 32

# 组件尺寸
BTN_HEIGHT_SM = 28; BTN_HEIGHT_MD = 34; BTN_HEIGHT_LG = 40
INPUT_HEIGHT = 32; CORNER_RADIUS = 8; CORNER_RADIUS_LG = 12
...
BAILIAN_MODEL_MAP = {
    "图像生成 (Image)": [
        ...
        "qwen-image-2.0-pro-2026-03-03", "wan2.7-image-pro",
        "qwen-image-2.0", "qwen-image-2.0-2026-03-03", "wan2.7-image",
    ],
    "视频生成 (Video)": [
...
VIDU_MODEL_DURATION = {
    "viduq3-pro": (1, 16), "viduq3-turbo": (1, 16),
    "viduq2": (1, 10), "viduq1": (5, 5),
}


# ============ 默认配置 ============
DEFAULT_CONFIG = {
    "api_provider": "Xiaomi MiMo",
    "api_website": "https://platform.xiaomimimo.com",
    ...
    "api_auth_field": "ANTHROPIC_AUTH_TOKEN (默认)",
    "api_custom_header": "Authorization",
    "api_adv_expanded": False,
