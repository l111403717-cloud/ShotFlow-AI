...
from ..constants import (C, FONT_TITLE, FONT_H2, FONT_BODY, FONT_MONO, FONT_SMALL,
                         PAD_MD, PAD_LG, CORNER_RADIUS, VISUAL_SUFFIX, SYSTEM_PROMPT)
...
class ScriptMixin:
    ...
    def generate_script(self, idea):
        ...
        try:
            ...
            payload = {"model": model, "temperature": 0.8, "max_tokens": 16384,
            ...
            if response.status_code == 200:
                ...
                self._update_script_text(f"API 错误: HTTP {response.status_code}\n{response.text[:500]}")
